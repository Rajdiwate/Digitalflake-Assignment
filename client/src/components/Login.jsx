  ...
  return (
    <div className="relative w-full max-w-md bg-white shadow-xl rounded-lg z-20 lg:left-[-190px] lg:top-4 py-8 left-0  top-0">
                ...
                <form className="p-6 space-y-6 bg-white">
                    ...
                    <div className='text-center'>Do not have an Account? <span onClick={()=>{loginState.setIsLogin(false)}} className='text-blue-700 hover:underline hover:cursor-pointer'>Signup</span></div>
                </form>
